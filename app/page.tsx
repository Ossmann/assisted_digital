                ...
                if (part.type === 'tool-displayMomentus') {
                  switch (part.state) {
                    ...
                    case 'output-available':
                      return (
                        <div key={index} className="weather-widget">
                          <Momentus {...(part.output as LinkProps)} />
                        </div>
                      );
